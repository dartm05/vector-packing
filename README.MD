...
│   │   └── crowd_builder.py       # Builds solutions using patterns
│   │
...
- 🔍 VM affinity heatmaps
- ⚖️ Side-by-side GA vs WoC comparison
- 📈 Resource utilization charts

See `examples/GUI_README.md` for detailed instructions.
